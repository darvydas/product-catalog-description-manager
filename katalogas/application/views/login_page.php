...
<head>
	...
	<title>Katalogas::Prisijungimas</title>
  ...
  <div class="container">
    <div class="inside">
      <div class="wrapper">
		<section id="content">
		  <article>
			<h2 class="pageH2">Jums būtina <span>prisijungti</span></h2>
				<?php echo validation_errors(); ?> 
				<?php echo form_open('login'); ?>
				<table>
					<tr><td>Prisijungimo vardas</td><td><?php echo form_input('login', $this->input->post('login')); ?></td></tr>
					<tr><td>Slaptažodis</td><td><?php echo form_password('pass'); ?></td></tr>
					<tr><td><?php echo form_submit('login_submit', 'Prisijungti'); ?></td><td><?php echo anchor ('register', 'Registracija');?></td></tr>
				</table>
				<?php echo form_close(); ?>
		  </article>
		</section>
