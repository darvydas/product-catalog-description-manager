...
arrowimages: {down:['downarrowclass', 'http://rude.su.lt/~silkus/katalogas/failai/images/ddsmoothmenu/down.gif', 23], right:['rightarrowclass', 'http://rude.su.lt/~silkus/katalogas/failai/images/ddsmoothmenu/right.gif', 6]},
...
buildsubheaders: function($, $headers, setting, method, prevobjs){
	...
	$headers.each(function(){ //loop through each LI header
		...
		var $link = $curobj.children("a:eq(0)").append( //add arrow images
			'<span style="display: block;" class="' + smoothmenu.arrowimages[/*'down'*/'right'][0] + '"></span>'
		);
		var dimensions = {
			w	: $link.outerWidth(),
			subulw	: $subul.outerWidth(),
